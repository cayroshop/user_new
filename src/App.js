...
function App() {
  ...
  return (
    <>
      <BlogProvider>
        <Helmet>
          <title>Cayorshop</title>
          <meta
            name="description"
            content="Welcome to CayroShop, your premier destination for all things electronic and appliance-related. At CayroShop, we believe in providing our customers with the latest and greatest in technology, delivered with unparalleled customer service and satisfaction."
          />
        </Helmet>
        <Toaster />
        ...
        <Routes>
          ...
          <Route
            path="/login"
            element={<UserLogin updateAuthStatus={setIsUserAuthenticated} />}
          />
          ...
          <Route
            path="/checkout"
            element={<Checkout updateAuthStatus={setIsUserAuthenticated} />}
          />
          ...
          <Route
            path="/wishList"
            element={
              isUserAuthenticated ? <WishList /> : <Navigate to="/login" />
            }
          />
          ...
          <Route
            path="/comparsion"
            element={
              isUserAuthenticated ? <Comparsion /> : <Navigate to="/login" />
            }
          />
          ...
          <Route
            path="/account"
            element={
              isUserAuthenticated ? <Account /> : <Navigate to="/login" />
            }
          />
          <Route
            path="/account/order/:userId/:orderId"
            element={
              isUserAuthenticated ? (
                <AccountOrderView />
              ) : (
          ...
          <Route
            path="/account/orders"
            element={
              isUserAuthenticated ? <AccountOrder /> : <Navigate to="/login" />
            }
          />
